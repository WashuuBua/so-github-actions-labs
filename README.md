...
![CI Status](https://github.com/WashuuBua/so-github-actions-labs/actions/workflows/ci.yml/badge.svg)
![Security Scan](https://github.com/WashuuBua/so-github-actions-labs/actions/workflows/security-scan.yml/badge.svg)
![Production Release](https://github.com/WashuuBua/so-github-actions-labs/actions/workflows/release.yml/badge.svg)
...
* Sistema de Archivos: Manipulación de permisos (chmod) y variables de entorno.

## Arquitectura del Pipeline
El siguiente diagrama ilustra la interacción entre los workflows y los runners del sistema operativo:

```mermaid
graph TD
    User[Usuario] -->|Push / Manual| GitHub[GitHub Actions]
    GitHub -->|Dispara| Matrix[Matriz de Estrategia]
    ...
    Linux -->|Construye| Docker[Contenedor Docker Alpine]
    Docker -->|Reporta| Stats[CPU/RAM Logs]
    
    Linux -->|Despliega| Release[Simulación Producción]
